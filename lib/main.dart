...
calendarRow(context) {
  ...
  return Row(
    ...
    children: [
      Expanded(
        // Expanded widget makes the ListView take up all the space left by the button
        child: SizedBox(
          height: 65,
          child: ListView.builder(
            // This scroll direction is horizontal for a side-scrolling list
            scrollDirection: Axis.horizontal,
            itemCount: 14, // The number of items in the list
            itemBuilder: (BuildContext context, int index) {
              // You can customize the size of the container as needed
              return SizedBox(
                width: 55, // Width of each item
                // height: 55,
                child: Column(
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        fontFamily: 'Lexend',
                        color:
                            index == 0 ? Colors.black : const Color(0xFF6B7280),
                      ),
                    ),
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        fontSize: 15,
                        color:
                            index == 0 ? const Color(0xFF057747) : Colors.black,
                      ),
                    ),
                    Text(
                      duration[index],
